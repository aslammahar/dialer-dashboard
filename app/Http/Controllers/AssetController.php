...
//        dd($request->all());
        if(\Auth::user()->can('create assets'))
        {
            ...
            $assets = new Asset();
                        ...
                        $assets->serial_number = $request->serial_number; // Add serial_number
                        $assets->model = $request->model; // Add model
                        $assets->condition = $request->condition; // Add condition
                        $assets->given_by = $request->given_by; // Add given_by
                       // $assets->given_date = $request->given_date; // Add given_date
