...
class WarningController extends Controller
{
    ...
    public function create()
    {
        if(\Auth::user()->can('create warning'))
        {
            ...
            {
                $users = User::whereNotIn('type', ['Avatar', 'Closer', 'Voice', 'Client','customer','QA','Agant','Dialer Support'])
                ->get()->pluck('name', 'id');
                //  dd($users);
            ...
            return view('warning.create', compact('employees','users', 'current_employee'));
        }
        else
        {
