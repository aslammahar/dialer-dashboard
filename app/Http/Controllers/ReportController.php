...
class ReportController extends Controller
{
    ...
    ->groupBy('bank_accounts.id', 'bank_accounts.holder_name', 'bank_accounts.bank_name') // Include all selected columns from bank_accounts
    ->selectRaw('sum(amount) as total')
    ->where('revenues.created_by', '=', \Auth::user()->creatorId());
