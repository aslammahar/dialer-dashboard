...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $superAdmin = User::create(
            [
                'name' => 'super sdmin',
                'email' => 'testsuperadmin@jsons.com',
                'password' => Hash::make('testsuperadmin@jsons.com'),
                'type' => 'super admin',
                'lang' => 'en',
                'avatar' => '',
                'created_by' => 0,
        ...
        $accountant = User::create(
            [
                'name' => 'accountant',
                'email' => 'accountant@jsonscomm.com',
                'password' => Hash::make('accountant@jsonscomm.com'),
                'type' => 'accountant',
                'default_pipeline' => 1,
                'lang' => 'en',
                'avatar' => '',
        ...
        $client = User::create(
            [
                'name' => 'client',
                'email' => 'client@jsons.com',
                'password' => Hash::make('client@jsons.com'),
                'type' => 'client',
                'default_pipeline' => 1,
                'lang' => 'en',
                'avatar' => '',
        ...
        Utility::priorities($company->id);
        Utility::labels($company->id);        
        Utility::groups($company->id);
