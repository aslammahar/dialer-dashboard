...
<head>
    <title>
        {{ Utility::getValByName('title_text') ? Utility::getValByName('title_text') : config('app.name', 'J.Sons HRM') }}
...
<table id="employee-table" class="table datatable dataTable-table">
    <!-- Table content here -->
</table>
<script>
