<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="{{ route('priorities.index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'priorities.index' ) ? 'active' : '' }}   ">{{__('Priorities')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
        ...
        <a href="{{ route('groups.index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'groups.index' ) ? 'active' : '' }}   ">{{__('Groups')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
