...
<div class="row">
    <div class="col-12">
        <h2>Add Dialer (Unified)</h2>

        <form action="{{ route('dialers-unified.store') }}" method="POST">
            @csrf
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('dialer_ip') is-invalid @enderror"
                                       id="dialer_ip" name="dialer_ip" value="{{ old('dialer_ip') }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('dialer_weblink') is-invalid @enderror"
                                       id="dialer_weblink" name="dialer_weblink" value="{{ old('dialer_weblink') }}">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('dialer_access') is-invalid @enderror"
                                       id="dialer_access" name="dialer_access" value="{{ old('dialer_access') }}">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('dialer_no') is-invalid @enderror"
                                       id="dialer_no" name="dialer_no" value="{{ old('dialer_no') }}">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('dialer_team') is-invalid @enderror"
                                       id="dialer_team" name="dialer_team" value="{{ old('dialer_team') }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('dialer_name') is-invalid @enderror"
                                       id="dialer_name" name="dialer_name" value="{{ old('dialer_name') }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('server_no') is-invalid @enderror"
                                       id="server_no" name="server_no" value="{{ old('server_no') }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('server_ip') is-invalid @enderror"
                                       id="server_ip" name="server_ip" value="{{ old('server_ip') }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('folder_name') is-invalid @enderror"
                                       id="folder_name" name="folder_name" value="{{ old('folder_name') }}">
