...
<div class="col-md-12">
    ...
    <div class="col-md-6">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{__('Lead Overall Progress ')}} <span>
                </div>
                <div class="card-body project_table">
                   <div  id="chart3"></div>
                </div>
         ...
         <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{__('Group Progress (Win Leads)')}} <span>
                </div>
                <div class="card-body project_table">
                   <div  id="chart4"></div>
                </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{__('Group Progress (Pending  Leads)')}} <span>
                </div>
                <div class="card-body project_table">
                   <div  id="chart5"></div>
                </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                   <h5>{{__('Group Progress (Loss  Leads)')}} <span>
                </div>
                <div class="card-body project_table">
                   <div  id="chart6"></div>
                </div>
