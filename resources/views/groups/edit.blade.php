...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-12">
            {{ Form::label('name', __('Group Name'),['class'=>'form-label']) }}
        ...
        <div class="form-group col-12">
            {{ Form::group('color', __('Color'),['class'=>'form-label']) }}
            <div class="row gutters-xs">
                @foreach($colors as $color)
                    <div class="col-auto">
                        <label class="colorinput">
                            <input name="color" type="radio" value="{{$color}}" @if($group->color == $color) checked @endif class="colorinput-input">
