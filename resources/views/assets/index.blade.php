                    ...
                    <div class="table-responsive">
                        <table class="table datatable">
                            ...
                            <tr>
                                <th>{{__('Name')}}</th>
                                <th>{{__('Users')}}</th>
                                <th>{{__('Model')}}</th> <!-- Add Model column -->
                                <th>{{__('Purchase Date')}}</th>
                                <th>{{__('Supported Date')}}</th>
                                <th>{{__('Amount')}}</th>
                                <th>{{__('Description')}}</th>
                                <th>{{__('Serial Number')}}</th> <!-- Add Serial Number column -->
                                <th>{{__('Condition')}}</th> <!-- Add Condition column -->
                                <th>{{__('Given By')}}</th> <!-- Add Given By column -->
                                <th>{{__('Action')}}</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach ($assets as $asset)
                                <tr>
                                    ...
                                    <td class="font-style">{{ $asset->model }}</td>
                                    <td class="font-style">{{ $asset->purchase_date }}</td>
                                    <td class="font-style">{{ $asset->supported_date }}</td>
                                    <td class="font-style">{{ $asset->amount }}</td>
                                    <td class="font-style">{{ $asset->description }}</td>
                                    <td class="font-style">{{ $asset->serial_number }}</td>
                                    <td class="font-style">{{ $asset->condition }}</td>
                                    <td class="font-style">{{ $asset->given_by }}</td>
