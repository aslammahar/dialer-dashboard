...
@section('title', 'Create Tax Slab')

@section('content')
<div class="mb-4">
    <div class="d-flex justify-content-between align-items-center">
        <h2>Create New Tax Slab</h2>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('tax-slabs.store') }}" method="POST" id="taxSlabForm">
            @csrf
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" 
                          ...
                          name="description" 
                          rows="3"
                          placeholder="e.g., Rs. 6,000 + 11% of amount exceeding Rs. 1,200,000">{{ old('description') }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Create Tax Slab
                </button>
                <a href="{{ route('tax-slabs.index') }}" class="btn btn-secondary">
