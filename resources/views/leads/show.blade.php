...
@section('action-btn')
    <div class="float-end">
        ...
        <a href="#" data-url="{{ URL::to('leads/'.$lead->id.'/priorities') }}" data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip" title="{{__('Priority')}}" class="btn btn-sm btn-primary">
        ...
        <a href="#" data-url="{{ URL::to('leads/'.$lead->id.'/groups') }}" data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip" title="{{__('Group')}}" class="btn btn-sm btn-primary">
