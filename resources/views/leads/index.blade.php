...
@section('action-btn')
    <div class="float-end">
        ...
        <a href="#" data-size="md"  data-url="{{ route('leads.create') }}"  data-ajax-popup="true" data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"  title="{{__('Create New Lead')}}">
            <i class="ti ti-plus"></i>
        </a>
...
<div class="d-flex">
    ...
    <div class="pt-3 ps-3">
        @php($priorities = $lead->priorities())
        @if($priorities)
            @foreach($priorities as $priority)
                    <div class="badge-xs badge bg-{{$priority->color}} p-2 px-3 rounded">{{$priority->name}}</div>               
    ...
    <div class="pt-3 ps-3">
        @php($groups = $lead->groups())
        @if($groups)
            @foreach($groups as $group)
                    <div class="badge-xs badge bg-{{$group->color}} p-2 px-3 rounded">{{$group->name}}</div>               
                                                    ...
                                                    <div class="btn-group card-option">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            @can('edit lead')
                                                                ...
                                                                <a href="#!" data-size="md" data-url="{{ URL::to('leads/'.$lead->id.'/priorities') }}" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="{{__('Priorities')}}">
                                                                ...
                                                                <a href="#!" data-size="md" data-url="{{ URL::to('leads/'.$lead->id.'/groups') }}" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="{{__('Groups')}}">
