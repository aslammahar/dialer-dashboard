...
<div class="row">
    <div class="col-12">
        ...
        <form action="{{ route('dialers.update', $dialerList->id) }}" method="POST">
            @csrf
            @method('PUT')
            
            @if(isset($dialerServer) && $dialerServer->id)
                <input type="hidden" name="dialer_server_id" value="{{ $dialerServer->id }}">
            @endif
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('dialer_ip') is-invalid @enderror" 
                                       id="dialer_ip" name="dialer_ip" value="{{ old('dialer_ip', $dialerList->dialer_ip) }}">
                                @error('dialer_ip')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('dialer_weblink') is-invalid @enderror" 
                                       id="dialer_weblink" name="dialer_weblink" value="{{ old('dialer_weblink', $dialerList->dialer_weblink) }}">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('dialer_access') is-invalid @enderror" 
                                       id="dialer_access" name="dialer_access" value="{{ old('dialer_access', $dialerList->dialer_access) }}">
                                @error('dialer_access')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('dialer_no') is-invalid @enderror" 
                                       id="dialer_no" name="dialer_no" value="{{ old('dialer_no', $dialerList->dialer_no) }}">
                                @error('dialer_no')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('dialer_team') is-invalid @enderror" 
                                       id="dialer_team" name="dialer_team" value="{{ old('dialer_team', $dialerList->dialer_team) }}">
                                @error('dialer_team')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('recording_link') is-invalid @enderror" 
                               id="recording_link" name="recording_link" value="{{ old('recording_link', $dialerList->recording_link) }}">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('dialer_name') is-invalid @enderror" 
                                       id="dialer_name" name="dialer_name" value="{{ old('dialer_name', $dialerServer->dialer_name ?? '') }}">
                                @error('dialer_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('server_no') is-invalid @enderror" 
                                       id="server_no" name="server_no" value="{{ old('server_no', $dialerServer->server_no ?? '') }}">
                                @error('server_no')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('server_ip') is-invalid @enderror" 
                                       id="server_ip" name="server_ip" value="{{ old('server_ip', $dialerServer->server_ip ?? '') }}">
                                @error('server_ip')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('folder_name') is-invalid @enderror" 
                                       id="folder_name" name="folder_name" value="{{ old('folder_name', $dialerServer->folder_name ?? '') }}">
                                @error('folder_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="server_status" name="server_status" value="1" {{ old('server_status', $dialerServer->server_status ?? '0') == '1' ? 'checked' : '' }}>
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary">Update Dialer</button>
            </div>
        </form>
    </div>
</div>
