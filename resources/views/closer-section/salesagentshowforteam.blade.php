    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('closer.salesagentshowforteamlead') }}" id="filterForm" class="row g-3">
                        <!-- Search Input -->
                        <div class="col-md-4">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="Search by closer, Agent name , status, etc...">
                        </div>
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            <div class="btn-group w-100" role="group">
                                ...
                                <a href="{{ route('closer.salesagentshowforteamlead') }}" class="btn btn-secondary">
                            ...
                            <td colspan="17" class="text-center py-4">
                                <div class="empty-state">
                                    ...
                                    @if(request('search') || request('start_date') || request('end_date'))
                                        ...
                                        <a href="{{ route('closer.salesagentshowforteamlead') }}" class="btn btn-outline-primary">
...
function exportData() {
    ...
    // Create export URL
    var exportUrl = '{{ route("team-sales.agent.export") }}?' + formData;
