...
@section('content')
    <h1>Create Campaign for Project: {{ $our_project->name }}</h1>
    ...
    <form action="{{ route('our_projects.our_campaigns.store', $our_project) }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <h2>Create Form Fields (Dynamic)</h2>
    ...
    <template id="field-template">
        <div class="form-group field-group">
            ...
            <div class="options-container" style="display: none;">
                <label>Options (comma-separated - one option per line):</label>
                <textarea name="fields[__INDEX__][options]" class="form-control"></textarea>
            </div>
            ...
            <label>Show Results To:</label>
            <select name="fields[__INDEX__][show_to][]" class="form-control" multiple required>
                <option value="user">User</option>
                <option value="qa">QA</option>
