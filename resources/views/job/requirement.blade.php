...
<head>
    ...
    <title>{{!empty($companySettings['title_text']) ? $companySettings['title_text']->value : config('app.name', 'Jsons Commmunication')}} - {{$job->title}}</title>
...
{{--    <link rel="stylesheet" href="{{ asset('libs/@fortawesome/fontawesome-free/css/all.min.css') }}">--}}
    ...
    <link rel="stylesheet" href="{{ asset('https://cdn.jsdelivr.net/npm/bootswatch@4.5.2/dist/darkly/bootstrap.min.css') }}" id="stylesheet">
