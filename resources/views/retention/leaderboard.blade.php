...
@section('page-title', 'Retention Leaderboard')
...
<div class="dd-wrap">
    ...
    <div class="dd-topbar">
        <div class="dd-brand">
            ...
            <div>
                <div class="dd-brand-title">Retention Leaderboard</div>
                <div class="dd-brand-sub">Live Inbound Calls from VICIdial CLOSERstats · ranked by calls handled</div>
            </div>
        </div>
        <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap">
            ...
            <a href="{{ route('retention.dashboard') }}" class="dd-readonly-badge" style="text-decoration:none">
                <i class="ti ti-arrow-left"></i> Back to Retention Dashboard
            </a>
            <div class="dd-sync">
                <span class="dd-dot"></span>
    ...
    <form class="dd-filters" method="GET" action="{{ route('retention.leaderboard') }}">
    @unless($isCloser)
    <div class="dd-field">
    ...
    <div class="dd-panel">
        <div class="dd-panel-head">
            <div>
                <div class="dd-panel-title">Inbound Calls Leaderboard</div>
