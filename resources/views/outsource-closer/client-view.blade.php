    ...
    <div class="dashboard-header">
        <div class="header-content">
            <div class="welcome-section">
                ...
                <div class="stats-bar">
                    <div class="stat-item">
                        <span class="stat-number">{{ $closedCalls->total() }}</span>
                        <span class="stat-label">Total Policies</span>
                    </div>
                    <div class="stat-item">
                        <span class="stat-number">{{ $closedCalls->where('status', 'approved')->count() }}</span>
                        <span class="stat-label">Approved</span>
                    </div>
                    <div class="stat-item">
                        <span class="stat-number">{{ $closedCalls->where('status', 'pending')->count() }}</span>
                        <span class="stat-label">Pending</span>
                    </div>
                    <div class="stat-item">
                        <span class="stat-number">{{ $closedCalls->where('status', 'rejected')->count() }}</span>
