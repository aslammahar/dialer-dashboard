                        ...
                        <tr>
                            <td class="time-column">
                                <div class="time-display">
                                    <strong>{{ $closedCall->created_at->setTimezone('Asia/Karachi')->format('Y-m-d') }}</strong>
                                    <small class="d-block text-muted">{{ $closedCall->created_at->setTimezone('Asia/Karachi')->format('h:i A') }}</small>
                                </div>
                            </td>
                            <td>{{ $closedCall->id }}</td>
