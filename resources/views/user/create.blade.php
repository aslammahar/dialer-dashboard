...
<div class="modal-body">
    <div class="row">
        ...
        {{-- Center Dropdown (admins only). For others, center_id is auto-assigned. --}}
        @if(\Auth::user()->canBypassCenterScope())
            <div class="col-md-6">
                <div class="form-group">
                    {{ Form::label('center_id', __('Center'), ['class' => 'form-label']) }}
                    {!! Form::select('center_id', $centers->prepend('-- Select Center --', ''), null, ['class' => 'form-control select2']) !!}
                    @error('center_id')
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="form-check form-switch">
                    {{ Form::checkbox('is_wfh', 1, false, ['class' => 'form-check-input', 'id' => 'is_wfh']) }}
