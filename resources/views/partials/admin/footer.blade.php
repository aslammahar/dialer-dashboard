...
<footer class="dash-footer">
    <div class="footer-wrapper">
        <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_217">copyright © <script>document.write(new Date().getFullYear())</script> @ jsonscomm&nbsp; &nbsp; </p></div>
