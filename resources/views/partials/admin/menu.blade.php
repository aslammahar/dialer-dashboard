@php
    ...
    // Logo by center: center_id 1 → logo2.png; center_id 2 or null → logo1.png (default)
    $header_logo = (Auth::check() && Auth::user()->center_id == 1)
        ? 'assets/images/logo2.png'
        : 'assets/images/logo1.png';
    $header_logo_is_center1 = (Auth::check() && Auth::user()->center_id == 1);
@endphp

<style>
    /* Logo2 (center 1) is larger – push down and constrain so it doesn’t overlap browser chrome */
    .main-logo.main-logo-center1 {
        margin-top: 14px;
        margin-bottom: 4px;
    }
    .main-logo.main-logo-center1 img {
        width: auto;
        object-fit: contain;
        display: block;
    }
...
<nav class="dash-sidebar light-sidebar transprent-bg">
    ...
    <a href="/">
        <div class="m-header main-logo {{ $header_logo_is_center1 ? 'main-logo-center1' : '' }}">
            <img src="{{ asset($header_logo) }}" alt="Logo">
        </div>
        </a>

        <div class="navbar-content">
            @if (!\in_array(\Auth::user()->type, ['client', 'recruiter', 'recruiter head']))
                <ul class="dash-navbar">
                    <!--------------------- Start Dashboard ----------------------------------->
                    {{-- Dashboard submenu only rendered if user has at least one "entry" permission.
                         Closing / outsource / closer teams live inside this block — without one of the
                         four dashboard permissions, those items never appear even if closing section is assigned. --}}
                    @if (Gate::check('show hrm dashboard') ||
                            ...
                            Gate::check('closing section') ||
                            Gate::check('outsource closing records') ||
                            Gate::check('closer teams'))
                        ...
                        <li
                            ...
                            <ul class="dash-submenu">
                                @if (\Auth::user()->show_crm() == 1)
                                    <li
                                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'crm-dashboard' ? ' active dash-trigger' : '' }}">
                                        ...
                                        <ul class="dash-submenu">
                                            @can('show crm dashboard')
                                                <li
                                                    ...
                                                    <a class="dash-link"
                                                        href="{{ route('crm.dashboard') }}">{{ __(' Lead') }}</a>
                                                </li>
                                            @endcan
                                ...
                                @can('view commissions')
                                    <li
                                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'crm-dashboard' ? ' active dash-trigger' : '' }}">
                                        <a class="dash-link" href="#">{{ __('Commission Reports ') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        ...
                                        <li
                                            ...
                                            <a class="dash-link"
                                                href="{{ route('commission.index') }}">{{ __('Commission Dashboard') }}</a>
                                        </li>
                                       
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('commission.comprehensive') }}">{{ __('Complete Reports') }}</a>
                                        </li>
                                ...
                                <li
                                    ...
                                    <a class="dash-link"
                                        href="{{ route('leave.index') }}">{{ __('Create Leave') }}</a>
                                </li>

                                @can('verifier')
                                                    <li
                                                        class="dash-item {{ request()->is('attendances*') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('verifier.assign') }}">{{ __('Assign Verfication') }}</a>
                                                    </li>
                                                @endcan
                                                @can('closing status update')
                                                    <li
                                                        class="dash-item {{ request()->is('attendances*') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('status-upload.index') }}">{{ __('Closing Status Update') }}</a>
                                                    </li>
                                                @endcan
                                                ...
                                                @can('attendances')
                                                    <li
                                                        class="dash-item {{ request()->is('attendances*') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('attendances.index') }}">{{ __('Employee Attendance') }}</a>
                                                    </li>
                                                @endcan
                                   ...
                                   <li
                                    class="dash-item {{ Request::route()->getName() == 'leave.index' ? 'active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('getAuthVendorUserReport') }}">{{ __('Vendor Reports') }}</a>
                                    </li>
                                    @endcan
                                 @can('realtime sales')
                                <li
                                    class="dash-item {{ Request::route()->getName() == 'leave.index' ? 'active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('center.competition') }}">{{ __('Realtime Sales') }}</a>
                                </li>
                                @endcan   

                                @can('accounts section')
                                    <li
                                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'crm-dashboard' ? ' active dash-trigger' : '' }}">
                                        <a class="dash-link" href="#">{{ __('Accounts ') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        ...
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('accounting.index') }}">{{ __('Accountants') }}</a>
                                        </li>
                                       
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('expense.entries.index') }}">{{ __('Daily Expense') }}</a>
                                        </li>
                                        
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('expense.entries.create') }}">{{ __('Create Daily Expense') }}</a>
                                        </li>
                                       
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('expense.monthly.index') }}">{{ __('Monthly Expense') }}</a>
                                        </li>
                                        
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('expense.monthly.create') }}">{{ __('Create Monthly Expense') }}</a>
                                        </li>
                                        
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('expense.report.filter') }}">{{ __('Daily Expense Report') }}</a>
                                        </li>
                                        
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('expense.entries.balance') }}">{{ __('Balance') }}</a>
                                        </li>
                                ...
                                @can('closing section')
                                    ...
                                    <li
                                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'crm-dashboard' ? ' active dash-trigger' : '' }}">
                                        <a class="dash-link" href="#">{{ __('Closing ') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>

                                        <ul class="dash-submenu">
                                            <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                                      <a href="{{ route('closer.search.existing') }}" class="dash-link">
                                   Search Duplicate
                                    </a>
                                        </li>
                                    
                                        @can('closed call records')
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('closed_calls.index') }}">{{ __('Closed Calls') }}</a>
                                        </li>
                                        @endcan 
                                         @can('agent sales')
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('closer.salesagentshow') }}">{{ __('Agent Sales') }}</a>
                                        </li>
                                        @endcan

                                        @can('agent sales for teamlead')
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('closer.salesagentshowforteamlead') }}">{{ __('Avatar Agent Sales') }}</a>
                                        </li>
                                        @endcan 
                                        ...
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('number-lists.index') }}">{{ __('Vendor Lists') }}</a>
                                        </li>
                                         @endcan 
                                        ...
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('closer.detailed.report') }}">{{ __('Sr . MTD Report') }}</a>
                                        </li>

                                         <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('jc.detailed.report') }}">{{ __('Jr . MTD Report') }}</a>
                                        </li>
                                        @endcan 

                                        @can('closed call reportings')
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('reporting.index') }}">{{ __('Reportings') }}</a>
                                        </li>
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('reporting.data-management') }}">{{ __('Manage Reportings') }}</a>
                                        </li>
                                        ...
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('closer.closerview') }}">{{ __('My Closed Calls') }}</a>
                                        </li>                             
                                        </ul>
                                    </li>
                                @endcan 
                                 ...
                                 @can('outsource closing records')
                                    <li
                                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'crm-dashboard' ? ' active dash-trigger' : '' }}">
                                        <a class="dash-link" href="#">{{ __('Outsource Closing ') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>

                                        <ul class="dash-submenu">
                                     @if(\App\Models\CloserTeam::where('team_lead_id', auth()->id())->exists())
                                        <li class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link" href="{{ route('outsource.index') }}">{{ __('Closed Calls') }}</a>
                                        </li>
                                        @endif
                                         @can('agent sales')
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('outsource.salesagentshow') }}">{{ __('Agent Sales') }}</a>
                                        </li>
                                        @endcan 
                                        ...
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('outsource.closerview') }}">{{ __('My Closed Calls') }}</a>
                                        </li>                             
                                        </ul>
                                    </li>
                                @endcan 
                                ...
                                @can('projects')
                                    <li
                                        ...
                                        <a class="dash-link" href="#">{{ __('Our Projects ') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        ...
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('our_projects.index') }}">{{ __('Projects') }}</a>
                                        </li>
                                ...
                                @can('closer teams')
                                    ...
                                    <li
                                        ...
                                        <a class="dash-link" href="#">{{ __('Closer Teams ') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        ...
                                        <li
                                            class="dash-item ">
                                            <a class="dash-link"
                                                href="{{ route('closer-teams.index') }}">{{ __('Closer Teams') }}</a>
                                        </li>
                                ...
                                @can('sales queue section')
                              
                                    <li
                                        class="dash-item ">

                                        <a class="dash-link" href="#">{{ __('Queue sales ') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        ...
                                        <li
                                            class="dash-item ">
                                            <a class="dash-link"
                                                href="{{ route('validators.index') }}">{{ __('Validator') }}</a>
                                        </li>
                                         <li
                                            class="dash-item ">
                                            <a class="dash-link"
                                                href="{{ route('queue-sales.index') }}">{{ __('Queue Sales') }}</a>
                                        </li>
                                ...
                                @can('get vendor')
                                    ...
                                    <li
                                        ...
                                        <a class="dash-link" href="#">{{ __('Vendor ') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        ...
                                        <li
                                            class="dash-item ">
                                            <a class="dash-link"
                                                href="{{ route('vendor-lists.index') }}">{{ __('Vendor List') }}</a>
                                        </li>
                                         <li
                                            class="dash-item ">
                                            <a class="dash-link"
                                                href="{{ route('data-vendor.index') }}">{{ __('Data Vendor') }}</a>
                                        </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li
                                        ...
                                        <ul class="dash-submenu">
                                                    ...
                                                    <li
                                                        ...
                                                        <a class="dash-link" href="#">{{ __('Salary Mananger') }}<span
                                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                                        ...
                                                        <li
                                                            class="dash-item ">
                                                            <a class="dash-link"
                                                                href="{{ route('salary-departments.index') }}">{{ __('Salary Department') }}</a>
                                                        </li>
                                                        <li
                                                            class="dash-item ">
                                                            <a class="dash-link"
                                                                href="{{ route('salary-structures.index') }}">{{ __('Salary Structure') }}</a>
                                                        </li>

                                                        <li
                                                            class="dash-item ">
                                                            <a class="dash-link"
                                                                href="{{ route('monthly-salaries.index') }}">{{ __('Monthly Salary Generation') }}</a>
                                                        </li>

                                                        <li
                                                            class="dash-item ">
                                                            <a class="dash-link"
                                                                href="{{ route('salary-slips.index') }}">{{ __('Salary SLips') }}</a>
                                                        </li>

                                                         <li
                                                            class="dash-item ">
                                                            <a class="dash-link"
                                                                href="{{ route('salary.payments.index') }}">{{ __('Salary Payments') }}</a>
                                                        </li>

                                                          <li
                                                            class="dash-item ">
                                                            <a class="dash-link"
                                                                href="{{ route('banks.index') }}">{{ __('Salary Banks') }}</a>
                                                        </li>

                                                         <li
                                                            class="dash-item ">
                                                            <a class="dash-link"
                                                                href="{{ route('tax-slabs.index') }}">{{ __('Tax Slabs') }}</a>
                                                        </li>

                                                        <li
                                                            class="dash-item ">
                                                            <a class="dash-link"
                                                                href="{{ route('tax-reports.index') }}">{{ __('Tax Reports') }}</a>
                                                        </li>
                                                ...
                                                @can('users personal data')
                                                    <li
                                                        class="dash-item {{ \Request::route()->getName() == 'hrm.dashboard' ? ' active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('hr.user.details.index') }}">{{ __(' Users Data') }}</a>
                                                    </li>
                                                @endcan
                                                ...
                                                <li class="dash-item ">
                                                                <a class="dash-link"
                                                                    href="{{ route('monitoring.my-monitoring') }}">{{ __('My Avatar Monitoring') }}</a>
                                                </li>

                                                <li class="dash-item ">
                                                    <a class="dash-link"
                                                    href="{{ route('avatar_monitoring.my_avatar_notifications') }}">{{ __('My Monitoring') }}</a>
                                                </li>
                                                ...
                                                @can('create team')
                                                    <li class="dash-item dash-hasmenu
                                                        ...
                                                        <a class="dash-link" href="#">{{ __('Team Management') }}<span
                                                                class="dash-arrow"><i
                                                                    data-feather="chevron-right"></i></span></a>
                                                        <ul class="dash-submenu">
                                                            <li class="dash-item ">
                                                                <a class="dash-link"
                                                                    href="{{ route('teams.create') }}">{{ __('Create Team') }}</a>
                                                            </li>
                                                            <li class="dash-item ">
                                                                <a class="dash-link"
                                                                    href="{{ route('team.assignment') }}">{{ __('Assign Agent') }}</a>
                                                            </li>
                                                            <li class="dash-item ">
                                                                <a class="dash-link"
                                                                    href="{{ route('agent_reports') }}">{{ __('Agent Report') }}</a>
                                                            </li>
                                                            <li class="dash-item ">
                                                                <a class="dash-link"
                                                                    href="{{ route('teams.overview') }}">{{ __('Remove Agent') }}</a>
                                                            </li>
                                                            <li class="dash-item ">
                                                                <a class="dash-link"
                                                                    href="{{ route('all.team.reports') }}">{{ __('Get Team Reports') }}</a>
                                                            </li>

                                                            <li class="dash-item ">
                                                                <a class="dash-link"
                                                                    href="{{ route('team.index') }}">{{ __('Team Management') }}</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                @endcan
                                                ...
                                                @can('manage lead')
                                                    ...
                                                    ">
                                                        ...
                                                        <a class="dash-link" href="#">{{ __('QA Section') }}<span
                                                                class="dash-arrow"><i
                                                                    data-feather="chevron-right"></i></span></a>
                                                        <ul class="dash-submenu">
                                                            <li class="dash-item ">
                                                                <a class="dash-link"
                                                                    href="{{ route('avatar-leads.show-qa-stats-form') }}">{{ __('Agent Stats') }}</a>
                                                            </li>
                                                         
                                                            <li class="dash-item ">
                                                                <a class="dash-link"
                                                                    href="{{ route('avatar_calls') }}">{{ __('MY Leads') }}</a>
                                                            </li>
                                                            <li class="dash-item ">
                                                                <a class="dash-link"
                                                                    href="{{ route('qa-section') }}">{{ __('QA section') }}</a>
                                                            </li>
                                                ...
                                                @can('manage monitoring')
                                                    ...
                                                    ">
                                                        ...
                                                        <a class="dash-link" href="#">{{ __('QA Monitoring') }}<span
                                                                class="dash-arrow"><i
                                                                    data-feather="chevron-right"></i></span></a>
                                                        <ul class="dash-submenu">
                                                            ...
                                                            <li class="dash-item ">
                                                                <a class="dash-link"
                                                                    href="{{ route('monitoring.index') }}">{{ __('All Monitoring Records') }}</a>
                                                            </li>


                                                            <li class="dash-item ">
                                                                <a class="dash-link"
                                                                    href="{{ route('monitoring.create') }}">{{ __('New Monitoring') }}</a>
                                                            </li>
                                                ...
                                                @can('manage monitoring')
                                                    ...
                                                    ">
                                                        ...
                                                        <a class="dash-link" href="#">{{ __('Avatar Monitoring') }}<span
                                                                class="dash-arrow"><i
                                                                    data-feather="chevron-right"></i></span></a>
                                                        <ul class="dash-submenu">
                                                            ...
                                                            <li class="dash-item ">
                                                                <a class="dash-link"
                                                                    href="{{ route('avatar_monitoring.index') }}">{{ __('Avatar Monitoring Records') }}</a>
                                                            </li>


                                                            <li class="dash-item ">
                                                                <a class="dash-link"
                                                                    href="{{ route('avatar_monitoring.create') }}">{{ __('New Monitoring') }}</a>
                                                            </li>
                    ...
                    @if (\Auth::user()->show_hrm() == 1)
                        @if (Gate::check('manage employee') || Gate::check('manage setsalary') || in_array(\Auth::user()->type, ['company', 'super admin'], true))
                            <li
                                ...
                                Request::segment(1) == 'department-support' ||
                                Request::segment(1) == 'designation' ||
                                Request::segment(1) == 'employee' ||
                                Request::segment(1) == 'attendances' ||
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    @if (Gate::check('support management') || Gate::check('support management'))
                                        <li
                                            class="dash-item dash-hasmenu  {{ Request::segment(1) == 'department-support' || Request::segment(1) == 'department-support' ? 'active dash-trigger' : '' }}">
                                            <a class="dash-link" href="#">{{ __('Department Support') }}<span
                                                    class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                            <ul class="dash-submenu">
                                                @can('support department create')
                                                    <li
                                                        class="dash-item {{ request()->is('department-support*') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('department_support.index') }}">{{ __('Department Create') }}</a>
                                                    </li>
                                                @endcan
                                           
                                                
                                                @can('support my tickets')
                                                    <li
                                                        class="dash-item {{ request()->is('department-support*') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('department_support_tickets.index') }}">{{ __('My Support') }}</a>
                                                    </li>
                                                @endcan


                                                @can('support summary dashboard')
                                                    <li
                                                        class="dash-item {{ request()->is('department-support*') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('tickets.dashboard') }}">{{ __('Ticket Sammary') }}</a>
                                                    </li>
                                                @endcan
                                            </ul>
                                        </li>
                                                    ...
                                                    <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'attendanceemployee' ? 'active dash-trigger' : '' }}"
                                                        ...
                                                        <ul class="dash-submenu">
                                                            <li
                                                                ...
                                                                <a class="dash-link"
                                                                    href="{{ route('attendanceemployee.index') }}">{{ __('WFH Attendance') }}</a>
                                                            </li>
                                                            <li
                                                                class="dash-item {{ Request::route()->getName() == 'attendanceemployee.index' ? 'active' : '' }}">
                                                                <a class="dash-link"
                                                                    href="{{ route('attendance') }}">{{ __('Onsite Attendance') }}</a>
                                                            </li>
                                    ...
                                    @if (Gate::check('manage job') ||
                                        ...
                                        <li
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                <li
                                                        class="dash-item {{ request()->is('recruitment*') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('recruitment.create') }}">{{ __('Initial Recruitment') }}</a>
                                                    </li>
                                                    <li
                                                        class="dash-item {{ request()->is('recruitments*') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('recruitments.index') }}">{{ __('Recruitments') }}</a>
                                                    </li>
                                                    <li
                                                        class="dash-item {{ request()->is('recruitments*') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('recruitment.search') }}">{{ __('Candidate Form') }}</a>
                                                    </li>

                                                    <li
                                                        class="dash-item {{ request()->is('recruitments*') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('recruitments.reports') }}">{{ __('Reports') }}</a>
                                                    </li>
                                    ...
                                    @if (Gate::check('manage award') ||
                                        ...
                                        <li
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                <li
                                                    class="dash-item {{ request()->is('suspension*') ? 'active' : '' }}">
                                                    <a class="dash-link"
                                                        href="{{ route('suspension.index') }}">{{ __('Suspension') }}</a>
                                                </li>
                    ...
                    @php
                        $isUserMgmtBypass = in_array(\Auth::user()->type, ['company', 'super admin'], true);
                    @endphp
                    @if ($isUserMgmtBypass || Gate::check('manage user') || Gate::check('manage role') || Gate::check('manage client'))
                        <li class="dash-item dash-hasmenu">
                            <a href="#!"
                                class="dash-link {{ Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'clients' ? ' active dash-trigger' : '' }}"><span
                                    ...
                                    class="dash-mtext">{{ __('User Management') }}</span><span class="dash-arrow"><i
                                        data-feather="chevron-right"></i></span></a>
                            <ul class="dash-submenu">
                                @if ($isUserMgmtBypass || Gate::check('manage user'))
                                    <li
                                ...
                                @if ($isUserMgmtBypass || Gate::check('manage role'))
                                    <li
                                ...
                                @if ($isUserMgmtBypass || Gate::check('manage client'))
                                    <li
                                ...
                                {{-- Center Link --}}
                                @can('manage center')
                                    <li class="dash-item {{ Request::route()->getName() == 'centers.index' || Request::route()->getName() == 'centers.create' || Request::route()->getName() == 'centers.edit' ? ' active' : '' }}">
                                        <a class="dash-link" href="{{ route('centers.index') }}">{{ __('Center') }}</a>
                                    </li>
                                @endcan
                            </ul>
                        </li>
                    ...
                    <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'support' ? 'active' : '' }}">
                            <a href="{{ route('reminders.index') }}" class="dash-link">
                                <span class="dash-micon"><i class="ti ti-bell"></i></span><span
                                    class="dash-mtext">{{ __('Reminder') }}</span>
                            </a>
                        </li>

                    @if (\Auth::user()->type != 'super admin')
                        <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'support' ? 'active' : '' }}">
                            <a href="{{ route('department_support_tickets.my_tickets') }}" class="dash-link">
                        ...
                        <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'chats' ? 'active' : '' }}">
                            <a href="https://Premium224.web-hosting.com:2096" class="dash-link">
                                <span class="dash-micon"><i class="ti ti-message-circle"></i></span><span
                                    class="dash-mtext">{{ __('Web Mail') }}</span>
                            </a>
                        </li>
                    @endif
            ...
            <ul class="dash-navbar">
                {{-- Dashboard --}}
                <li class="dash-item {{ \Request::route()->getName() == 'recruiter.dashboard' ? ' active' : '' }}">
                    <a href="{{ route('recruiter.dashboard') }}" class="dash-link">
                        <span class="dash-micon"><i class="ti ti-home"></i></span>
                        <span class="dash-mtext">{{ __('Dashboard') }}</span>
                    </a>
                </li>
                {{-- Create initial form --}}
                <li class="dash-item {{ \Request::route()->getName() == 'recruitment.create' ? ' active' : '' }}">
                    <a href="{{ route('recruitment.create') }}" class="dash-link">
                        <span class="dash-micon"><i class="ti ti-clipboard-plus"></i></span>
                        <span class="dash-mtext">{{ __('Create Initial Form') }}</span>
                    </a>
                </li>
                {{-- Final interview --}}
                <li class="dash-item {{ \Request::route()->getName() == 'recruitments.index' ? ' active' : '' }}">
                    <a href="{{ route('recruitments.index') }}" class="dash-link">
                        <span class="dash-micon"><i class="ti ti-clipboard-check"></i></span>
                        <span class="dash-mtext">{{ __('Final Interview') }}</span>
                    </a>
                </li>
                {{-- My performance report --}}
                <li class="dash-item {{ \Request::route()->getName() == 'recruitments.reports' ? ' active' : '' }}">
                    <a href="{{ route('recruitments.reports', ['recruiter' => \Auth::user()->name]) }}" class="dash-link">
                        <span class="dash-micon"><i class="ti ti-chart-line"></i></span>
                        <span class="dash-mtext">{{ __('My Performance') }}</span>
                    </a>
                </li>
            </ul>
            @endif
            ...
            {{-- =================== RECRUITER HEAD MENU =================== --}}
            @if (\Auth::user()->type == 'recruiter head')
            <ul class="dash-navbar">
                {{-- Team dashboard --}}
                <li class="dash-item {{ \Request::route()->getName() == 'recruiter.head.dashboard' ? ' active' : '' }}">
                    <a href="{{ route('recruiter.head.dashboard') }}" class="dash-link">
                        <span class="dash-micon"><i class="ti ti-layout-dashboard"></i></span>
                        <span class="dash-mtext">{{ __('Team Dashboard') }}</span>
                    </a>
                </li>
                {{-- Team performance report --}}
                <li class="dash-item {{ \Request::route()->getName() == 'recruitments.reports' ? ' active' : '' }}">
                    <a href="{{ route('recruitments.reports') }}" class="dash-link">
                        <span class="dash-micon"><i class="ti ti-chart-bar"></i></span>
                        <span class="dash-mtext">{{ __('Team Performance') }}</span>
                    </a>
                </li>
                {{-- All candidates list --}}
                <li class="dash-item {{ \Request::route()->getName() == 'recruitments.index' ? ' active' : '' }}">
                    <a href="{{ route('recruitments.index') }}" class="dash-link">
                        ...
                        <span class="dash-mtext">{{ __('All Candidates') }}</span>
                    </a>
                </li>
                {{-- Export data --}}
                <li class="dash-item">
                    <a href="{{ route('recruitments.exportExcel') }}" class="dash-link">
                        <span class="dash-micon"><i class="ti ti-file-spreadsheet"></i></span>
                        <span class="dash-mtext">{{ __('Export Report') }}</span>
                    </a>
                </li>
            </ul>
            @endif
