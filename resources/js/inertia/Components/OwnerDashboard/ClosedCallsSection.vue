...
/**
 * ClosedCallsSection
 * Purpose: Render the Closed Calls table inside the Owner Dashboard with debounced search and load more pagination.
 * Key Props:
 *   - closedCalls: Paginated closed calls data payload from the parent.
